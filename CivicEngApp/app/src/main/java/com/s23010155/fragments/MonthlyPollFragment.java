...
public class MonthlyPollFragment extends Fragment {
    ...
    @Override public View onCreateView(@NonNull LayoutInflater i, ViewGroup c, Bundle s) {
        binding = FragmentMonthlyPollBinding.inflate(i, c, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonBackToDashboard.setOnClickListener(v ->
                NavHostFragment.findNavController(this)
                        .navigate(R.id.action_monthlyPollFragment_to_dashboardFragment));
    }
